...
def render_to_pdf(html_string, base_url=None):
    """
    Converts an HTML string into a PDF bytestring.
    """
    if not HTML:
        # Return a simple text response instead of crashing if libs are missing
        return b"PDF Generation is unavailable. Please install Pango/GObject."
