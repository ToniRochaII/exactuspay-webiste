...
urlpatterns = [
    ...
    path("<slug:country_slug>/dashboard/<int:company_id>/", views.company_dashboard, name="company_dashboard"),
    path('<slug:country_slug>/access/<int:company_id>/', views.company_access_list, name='company_access_list'),

    path("<slug:country_slug>/allocation/", views.user_allocation_view, name="user_allocation"),
