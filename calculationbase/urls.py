...
urlpatterns = [
    ...
    path("<slug:country_slug>/calculationbase/edit/<int:regulations_id>/", views.calculationbase_edit, name="edit"),
    path("<slug:country_slug>/calculationbase/delete/<int:regulations_id>/", views.calculationbase_delete, name="delete"),
]
