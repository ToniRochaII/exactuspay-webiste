...
def employee_create(request, country_slug,company_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('employee:employee', slug=country_slug, company_id=company.pk)
    else:
        form = EmployeeForm()
...
def employee_edit(request, country_slug, company_id, employee_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('employee:employee', slug=country_slug, company_id=company.company_id)
    else:
